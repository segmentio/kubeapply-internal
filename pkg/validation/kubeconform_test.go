	...
	testCases := []testCase{
		...
		},
		{
			...
			expected: CheckResult{
				...
				Message:   "problem validating schema. Check JSON formatting: jsonschema: '/spec' does not validate with https://raw.githubusercontent.com/yannh/kubernetes-json-schema/master/v1.27.0-standalone-strict/deployment-apps-v1.json#/properties/spec/additionalProperties: additionalProperties 'invalidField' not allowed",
			},
		},
		{
			resource: MakeResource(
